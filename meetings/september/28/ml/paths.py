...
def sweep_fixture_dir():
    # a second fixture, generated by sim.boids.sweep rather than by
    # collect.py, so it carries more than one bounds mode
    return os.path.join(HERE, "data_runs", "sweep_fixture")
