...
```
cd ~/career/work/research/dr-patino/meetings/19-june && python3 -m sim.boids.live
```
...
```
xdg-open ~/career/work/research/dr-patino/meetings/19-june/deliverables/flock_escape.gif
```
